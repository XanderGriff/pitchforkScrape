...
const initializeReviewDataFile = async () => {
  const fileHeader =
    "ID,Artist,Album Name,Score,Genre,Date Posted,Author,Author Title,Label,Year Released,Pull Quote,Review Body,Word Count,Is Best New Music,Is Collection\n";
